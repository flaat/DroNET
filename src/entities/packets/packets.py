...
class Packet(Entity):
    ...
    def __init__(self, event_ref=None):
        """
        @param simulator:
        @param event_ref:
        """
        ...
        super().__init__(identifier=id(self), coordinates=event_ref.coordinates)
...
class DataPacket(Packet):
    ...
    def __init__(self, event_ref=None):
        ...
        """
        super().__init__(event_ref=event_ref)
...
class ACKPacket(Packet):
    ...
    def __init__(self, source_drone, destination_drone, acked_packet, event_ref):
        """
        @param simulator:
        @param source_drone:
...
class HelloPacket(Packet):
    ...
    def __init__(self, source_drone, current_position, current_speed, next_target, event_ref):
        """
        @param simulator:
        @param source_drone:
